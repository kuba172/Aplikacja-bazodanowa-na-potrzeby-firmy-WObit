...
require_once "connect.php";
		...
		try 
		{
			$_SESSION['konto_uprawnienia']=$_POST['login'];
			...
			{	
				...
				if($ile_kont==0)
				{
					header('Location: nadajuprawnienia4.php');
				} else {
				if (!$rezultat) throw new Exception($polaczenie->error);
				echo "<table>";
				echo "<tr>"."<td>"."<b>"."Nazwa użytkownika"."</td>"."<td>"."Uprawnienie do odczytywania danych"."</td>"." <td>"."Uprawnienie do modyfikacji danych"."</td>". "<td>"."Uprawnienie do dodawania nowych robotów"."</b>"."</b>"."<br/>"."</td>"."</tr>";
				
				  echo "<tr>"."<td>".$wiersz['user']."</td>"."<td>".$wiersz['Odczyt']."</td>"."<td>".$wiersz['Modyfikacja']."</td>"."<td>".$wiersz['Dodawanie/usuwanie']."<br/>"."</tr>";
				echo "</table>"; 
				}
			}
