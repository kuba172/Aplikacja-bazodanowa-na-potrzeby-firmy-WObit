...
<?php 
			...
			$polaczenie = new mysqli($host, $db_user, $db_password, $db_name);
				...
				//if (!$rezultat) throw new Exception($polaczenie->error);
				if($polaczenie->query("INSERT INTO roboty_test_b (id,data, miejsce_badania,	uczestnicy_badania, numer_vin_1, numer_vin_2, skaner_1, skaner_1_nr_seryjny, skaner_2, skaner_2_nr_seryjny,	numer_rysunku,	numer_schematu_elektrycznego,	rok_produkcji,	maksymalna_predkosc,	maksymalne_obciazenie,	maksymalne_dopuszczalne_obciazenie,	podloze, pola_detekcji,	inne, probka_testowa,	wymiary_probki,	umiejscowienie_probki,	sila_uruchamiajaca,	uzyte_przyrzady,	sposob_wykonania_testu,	uwagi_1,skaner_1_2_lewa,	predkosc_wozka_lewa,	obciazenie_wozka_lewa,	nachylenie_powierzchni_lewa,	wykryta_przez_skaner_lewa_pomiar_1,	wykryta_przez_skaner_lewa_pomiar_2,	wykryta_przez_skaner_lewa_pomiar_3,	zatrzymanie_wozka_lewa_pomiar_1,	zatrzymanie_wozka_lewa_pomiar_2	,zatrzymanie_wozka_lewa_pomiar_3,	droga_hamowania_lewa_pomiar_1,	droga_hamowania_lewa_pomiar_2,	droga_hamowania_lewa_pomiar_3,	skaner_1_skaner_2_srodek,	predkosc_wozka_srodek,	obciazenie_wozka_srodek,	nachylenie_powierzchni_srodek,	wykryta_przez_skaner_srodek_pomiar_1,	wykryta_przez_skaner_srodek_pomiar_2,	wykryta_przez_skaner_srodek_pomiar_3,	zatrzymanie_wozka_srodek_pomiar_1,	zatrzymanie_wozka_srodek_pomiar_2,	zatrzymanie_wozka_srodek_pomiar_3,	droga_hamowania_srodek_pomiar_1	,droga_hamowania_srodek_pomiar_2,	droga_hamowania_srodek_pomiar_3	,skaner_1_skaner_2_prawa,	predkosc_wozka_prawa,	obciazenie_wozka_prawa,	nachylenie_powierzchni_prawa,	wykryta_przez_skaner_prawa_pomiar_1,	wykryta_przez_skaner_prawa_pomiar_2,	wykryta_przez_skaner_prawa_pomiar_3,	zatrzymanie_wozka_prawa_pomiar_1,	zatrzymanie_wozka_prawa_pomiar_2,	zatrzymanie_wozka_prawa_pomiar_3,	droga_hamowania_prawa_pomiar_1	,droga_hamowania_prawa_pomiar_2,	droga_hamowania_prawa_pomiar_3) VALUES ('$x','$data', '$miejsce','$uczestnicy','$numer_1','$numer_2','$skaner_1','$skaner_1_nr_ser','$skaner_2','$skaner_2_nr_ser','$nr_rys','$nr_schematu_elektrycznego','$rok_produkcji','$max_predkosc','$maksymalne_obciazenie','$maksymalne_dopuszczalne_obciazenie','$podloze','$pola_detekcji','$inne','$probka_testowa','$wymiary_probki','$umiejscowienie','$sila_uruchamiajaca','$uzyte_przyrzady','$sposob_wykonania_testu','$uwagi_probka_testowa','$skaner_1_skaner_2_lewa','$predkosc_wozka_lewa','$obciazenie_wozka_lewa','$nachylenie_powierzchni_lewa','$wykryta_przez_skaner_lewa_pomiar_1','$wykryta_przez_skaner_lewa_pomiar_2','$wykryta_przez_skaner_lewa_pomiar_3','$zatrzymanie_wozka_lewa_pomiar_1','$zatrzymanie_wozka_lewa_pomiar_2','$zatrzymanie_wozka_lewa_pomiar_3','$droga_hamowania_lewa_pomiar_1','$droga_hamowania_lewa_pomiar_2','$droga_hamowania_lewa_pomiar_3','$skaner_1_skaner_2_srodek','$predkosc_wozka_srodek','$obciazenie_wozka_srodek','$nachylenie_powierzchni_srodek','$wykryta_przez_skaner_srodek_pomiar_1','$wykryta_przez_skaner_srodek_pomiar_2','$wykryta_przez_skaner_srodek_pomiar_3','$zatrzymanie_wozka_srodek_pomiar_1','$zatrzymanie_wozka_srodek_pomiar_2','$zatrzymanie_wozka_srodek_pomiar_3','$droga_hamowania_srodek_pomiar_1','$droga_hamowania_srodek_pomiar_2','$droga_hamowania_srodek_pomiar_3','$skaner_1_skaner_2_prawa','$predkosc_wozka_prawa','$obciazenie_wozka_prawa','$nachylenie_powierzchni_prawa','$wykryta_przez_skaner_prawa_pomiar_1','$wykryta_przez_skaner_prawa_pomiar_2','$wykryta_przez_skaner_prawa_pomiar_3','$zatrzymanie_wozka_prawa_pomiar_1','$zatrzymanie_wozka_prawa_pomiar_2','$zatrzymanie_wozka_prawa_pomiar_3','$droga_hamowania_prawa_pomiar_1','$droga_hamowania_prawa_pomiar_2','$droga_hamowania_prawa_pomiar_3')")===TRUE)
				{
					header('Location: test_b.php');
				} 
				
				if($data!=null)
				{
				$polaczenie->query("UPDATE roboty_test_b SET data='$data' WHERE id='$x'");
				}
				if($miejsce!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET miejsce_badania='$miejsce' WHERE id='$x'");
				}
				if($uczestnicy!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET uczestnicy_badania='$uczestnicy' WHERE id='$x'");
				}
				if($numer_1!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET numer_vin_1='$numer_1' WHERE id='$x'");
				}
				if($numer_2!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET numer_vin_2='$numer_2' WHERE id='$x'");
				}
				
				if($skaner_1!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET skaner_1='$skaner_1' WHERE id='$x'");
				}
				if($skaner_1_nr_ser!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET skaner_1_nr_seryjny='$skaner_1_nr_ser' WHERE id='$x'");
				}
				if($skaner_2!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET skaner_2='$skaner_2' WHERE id='$x'");
				}
				if($skaner_2_nr_ser!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET skaner_2_nr_seryjny='$skaner_2_nr_ser' WHERE id='$x'");
				}
				if($nr_rys!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET numer_rysunku='$nr_rys' WHERE id='$x'");
				}
				
				if($nr_schematu_elektrycznego!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET numer_schematu_elektrycznego='$nr_schematu_elektrycznego' WHERE id='$x'");
				}
				
				if($rok_produkcji!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET rok_produkcji='$rok_produkcji' WHERE id='$x'");
				}
				
				if($max_predkosc!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET maksymalna_predkosc='$max_predkosc' WHERE id='$x'");
				}
				
				if($maksymalne_obciazenie!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET maksymalne_obciazenie='$maksymalne_obciazenie' WHERE id='$x'");
				}
				///////
				if($maksymalne_dopuszczalne_obciazenie!=null)
				{
				$polaczenie->query("UPDATE roboty_test_b SET maksymalne_dopuszczalne_obciazenie='$maksymalne_dopuszczalne_obciazenie' WHERE id='$x'");
				}
				
				if($podloze!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET podloze='$podloze' WHERE id='$x'");
				}
				
				if($pola_detekcji!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET pola_detekcji='$pola_detekcji' WHERE id='$x'");
				}
				
				if($inne!=null)
				{
				$polaczenie->query("UPDATE roboty_test_b SET inne='$inne' WHERE id='$x'");
				}
                
				if($probka_testowa!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET probka_testowa='$probka_testowa' WHERE id='$x'");
				}
				
				if($wymiary_probki!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET wymiary_probki='$wymiary_probki' WHERE id='$x'");
				}
				
				if($umiejscowienie!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET umiejscowienie_probki='$umiejscowienie' WHERE id='$x'");
				}
				
				if($sila_uruchamiajaca!=null)
				{
				$polaczenie->query("UPDATE roboty_test_b SET sila_uruchamiajaca='$sila_uruchamiajaca' WHERE id='$x'");
				}
				
				if($uzyte_przyrzady!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET uzyte_przyrzady='$uzyte_przyrzady' WHERE id='$x'");
				}
				
				if($sposob_wykonania_testu!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET sposob_wykonania_testu='$sposob_wykonania_testu' WHERE id='$x'");
				}
				
				if($uwagi_probka_testowa!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET uwagi_1='$uwagi_probka_testowa' WHERE id='$x'");
				}
				
				if($skaner_1_skaner_2_lewa!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET skaner_1_2_lewa='$skaner_1_skaner_2_lewa' WHERE id='$x'");
				}
				
				if($predkosc_wozka_lewa!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET predkosc_wozka_lewa='$predkosc_wozka_lewa' WHERE id='$x'");
				}
				
				if($obciazenie_wozka_lewa!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET obciazenie_wozka_lewa='$obciazenie_wozka_lewa' WHERE id='$x'");
				}
				
				if($nachylenie_powierzchni_lewa!=null)
				{
				$polaczenie->query("UPDATE roboty_test_b SET nachylenie_powierzchni_lewa='$nachylenie_powierzchni_lewa' WHERE id='$x'");
				}
				
				if($wykryta_przez_skaner_lewa_pomiar_1!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET wykryta_przez_skaner_lewa_pomiar_1='$wykryta_przez_skaner_lewa_pomiar_1' WHERE id='$x'");
				}
				
				if($wykryta_przez_skaner_lewa_pomiar_2!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET wykryta_przez_skaner_lewa_pomiar_2='$wykryta_przez_skaner_lewa_pomiar_2' WHERE id='$x'");
				}
				
				if($wykryta_przez_skaner_lewa_pomiar_3!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET wykryta_przez_skaner_lewa_pomiar_3='$wykryta_przez_skaner_lewa_pomiar_3' WHERE id='$x'");
				}
				
				if($zatrzymanie_wozka_lewa_pomiar_1!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET zatrzymanie_wozka_lewa_pomiar_1='$zatrzymanie_wozka_lewa_pomiar_1' WHERE id='$x'");
				}
				
				if($zatrzymanie_wozka_lewa_pomiar_2!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET zatrzymanie_wozka_lewa_pomiar_2='$zatrzymanie_wozka_lewa_pomiar_2' WHERE id='$x'");
				}
				
				if($zatrzymanie_wozka_lewa_pomiar_3!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET zatrzymanie_wozka_lewa_pomiar_3='$zatrzymanie_wozka_lewa_pomiar_3' WHERE id='$x'");
				}
				
				if($droga_hamowania_lewa_pomiar_1!=null)
				{
				$polaczenie->query("UPDATE roboty_test_b SET droga_hamowania_lewa_pomiar_1='$droga_hamowania_lewa_pomiar_1' WHERE id='$x'");
				}
				
				if($droga_hamowania_lewa_pomiar_2!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET droga_hamowania_lewa_pomiar_2='$droga_hamowania_lewa_pomiar_2' WHERE id='$x'");
				}
				
				if($droga_hamowania_lewa_pomiar_3!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET droga_hamowania_lewa_pomiar_3='$droga_hamowania_lewa_pomiar_3' WHERE id='$x'");
				}
				
				if($skaner_1_skaner_2_srodek!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET skaner_1_skaner_2_srodek='$skaner_1_skaner_2_srodek' WHERE id='$x'");
				}
				
				if($predkosc_wozka_srodek!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET predkosc_wozka_srodek='$predkosc_wozka_srodek' WHERE id='$x'");
				}
				
				if($obciazenie_wozka_srodek!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET obciazenie_wozka_srodek='$obciazenie_wozka_srodek' WHERE id='$x'");
				}
				
				if($nachylenie_powierzchni_srodek!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET nachylenie_powierzchni_srodek	='$nachylenie_powierzchni_srodek' WHERE id='$x'");
				}
				
				if($wykryta_przez_skaner_srodek_pomiar_1!=null)
				{
				$polaczenie->query("UPDATE roboty_test_b SET wykryta_przez_skaner_srodek_pomiar_1='$wykryta_przez_skaner_srodek_pomiar_1' WHERE id='$x'");
				}
				
				if($wykryta_przez_skaner_srodek_pomiar_2!=null)
				{
				$polaczenie->query("UPDATE roboty_test_b SET wykryta_przez_skaner_srodek_pomiar_2='$wykryta_przez_skaner_srodek_pomiar_2' WHERE id='$x'");
				}
				
				if($wykryta_przez_skaner_srodek_pomiar_3!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET wykryta_przez_skaner_srodek_pomiar_3='$wykryta_przez_skaner_srodek_pomiar_3' WHERE id='$x'");
				}
				
				if($zatrzymanie_wozka_srodek_pomiar_1!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET zatrzymanie_wozka_srodek_pomiar_1='$zatrzymanie_wozka_srodek_pomiar_1' WHERE id='$x'");
				}
				
				if($zatrzymanie_wozka_srodek_pomiar_2!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET zatrzymanie_wozka_srodek_pomiar_2='$zatrzymanie_wozka_srodek_pomiar_2' WHERE id='$x'");
				}
				
				if($zatrzymanie_wozka_srodek_pomiar_3!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET zatrzymanie_wozka_srodek_pomiar_3='$zatrzymanie_wozka_srodek_pomiar_3' WHERE id='$x'");
				}
				
				if($droga_hamowania_srodek_pomiar_1!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET droga_hamowania_srodek_pomiar_1='$droga_hamowania_srodek_pomiar_1' WHERE id='$x'");
				}
				
				if($droga_hamowania_srodek_pomiar_2!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET droga_hamowania_srodek_pomiar_2='$droga_hamowania_srodek_pomiar_2' WHERE id='$x'");
				}
				if($droga_hamowania_srodek_pomiar_3!=null)
				{
				 $polaczenie->query("UPDATE roboty_test_b SET droga_hamowania_srodek_pomiar_3='$droga_hamowania_srodek_pomiar_3' WHERE id='$x'");
				}
				...
				{
                $polaczenie->query("UPDATE roboty_test_b SET skaner_1_skaner_2_prawa='$skaner_1_skaner_2_prawa' WHERE id='$x'");
				}
				
				if($predkosc_wozka_prawa!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET predkosc_wozka_prawa='$predkosc_wozka_prawa' WHERE id='$x'");
				}
				
				if($obciazenie_wozka_prawa!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET obciazenie_wozka_prawa='$obciazenie_wozka_prawa' WHERE id='$x'");
				}
				
				if($nachylenie_powierzchni_prawa!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET nachylenie_powierzchni_prawa='$nachylenie_powierzchni_prawa' WHERE id='$x'");
				}
				
				if($wykryta_przez_skaner_prawa_pomiar_1!=null)
				{
				$polaczenie->query("UPDATE roboty_test_b SET wykryta_przez_skaner_prawa_pomiar_1='$wykryta_przez_skaner_prawa_pomiar_1' WHERE id='$x'");
				}
				
				
				if($wykryta_przez_skaner_prawa_pomiar_2!=null)
				{
				 $polaczenie->query("UPDATE roboty_test_b SET wykryta_przez_skaner_prawa_pomiar_2='$wykryta_przez_skaner_prawa_pomiar_2' WHERE id='$x'");
				}
				
				if($wykryta_przez_skaner_prawa_pomiar_3!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET wykryta_przez_skaner_prawa_pomiar_3='$wykryta_przez_skaner_prawa_pomiar_3' WHERE id='$x'");
				}
				
				if($zatrzymanie_wozka_prawa_pomiar_1!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET zatrzymanie_wozka_prawa_pomiar_1='$zatrzymanie_wozka_prawa_pomiar_1' WHERE id='$x'");
				}
				
				if($zatrzymanie_wozka_prawa_pomiar_2!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET zatrzymanie_wozka_prawa_pomiar_2='$zatrzymanie_wozka_prawa_pomiar_2' WHERE id='$x'");
				}
				
				if($zatrzymanie_wozka_prawa_pomiar_3!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET zatrzymanie_wozka_prawa_pomiar_3='$zatrzymanie_wozka_prawa_pomiar_3' WHERE id='$x'");
				}
				
				if($droga_hamowania_prawa_pomiar_1!=null)
				{
                $polaczenie->query("UPDATE roboty_test_b SET droga_hamowania_prawa_pomiar_1='$droga_hamowania_prawa_pomiar_1' WHERE id='$x'");
				}
				
				//
				if($droga_hamowania_prawa_pomiar_2!=null)
				{
				$polaczenie->query("UPDATE roboty_test_b SET droga_hamowania_prawa_pomiar_2='$droga_hamowania_prawa_pomiar_2' WHERE id='$x'");
				}
				
				if($droga_hamowania_prawa_pomiar_3!=null)
				{
				$polaczenie->query("UPDATE roboty_test_b SET droga_hamowania_prawa_pomiar_3='$droga_hamowania_prawa_pomiar_3' WHERE id='$x'");
				}
